...
(function() {
  ...
  Stopwatch = (function() {
    ...
    Stopwatch.prototype.config = {
      accuracy: 1000
    };

    Stopwatch.prototype.value = 0;

    Stopwatch.prototype.laps = [];
    ...
    Stopwatch.prototype.start = function() {
      return interval = setInterval(this.update, this.config.accuracy);
    };
    ...
    Stopwatch.prototype.lap = function() {
      return this.laps.push(this.value);
    };
...
angular.module("Mac").filter("secondsAsTime", function() {
  return function(seconds) {};
});

angular.module("Mac").directive("macStopwatch", function() {
  return {
    restrict: "E",
    replace: true,
    ...
    link: function($scope, element, attributes) {
      ...
      $scope.onStop = function() {
        return $scope.stopwatch.stop();
      };
      $scope.onReset = function() {
        return $scope.stopwatch.reset();
      };
      attributes.$observe('startAvailable', function(val) {
        return $scope.startAvailable = val !== 'false' && val !== "0";
      });
      attributes.$observe('stopAvailable', function(val) {
        return $scope.stopAvailable = val !== 'false' && val !== "0";
      });
      return attributes.$observe('resetAvailable', function(val) {
        return $scope.resetAvailable = val !== 'false' && val !== "0";
      });
    }
  };
});
...
angular.module("Mac").directive("macTagAutocomplete", [
  "$parse", "$timeout", "keys", "util", function($parse, $timeout, keys, util) {
    return {
      ...
      compile: function(element, attrs) {
        var attrsObject, delay, labelKey, queryKey, tagLabelKey, textInput, valueKey;
        ...
        return function($scope, element, attrs) {
          ...
          $scope.focusTextInput = function() {
            return angular.element(".text-input", element).focus();
          };
          $timeout(function() {
            ...
            if ((events = attrs.macTagAutocompleteEvents)) {
              ...
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                _results.push((function(name, eventFn) {
                  return angular.element(".text-input", element).on(name, function($event) {
                    var expression;
